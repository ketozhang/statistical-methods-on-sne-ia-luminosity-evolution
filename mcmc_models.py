...
if __name__ == "__main__":
    ...
    # hr = data["HR"]
    # hr_err = data["HR_err"]
    # results = run_lee20(age, age_err, hr, hr_err, linmix_kwargs=dict(K=2))
    # results.to_csv("results/run_lee20_1.csv", index=False)
    ...
    # hr = hr_df["hr"]
    # hr_err = hr_df["hr_err"]
    # results = run_lee20(age, age_err, hr, hr_err)
    # results.to_csv("results/run_lee20_2.csv", index=False)
    ...
    hr = df["hr"]
    hr_err = df["hr_err"]
    results = run_lee20(age, age_err, hr, hr_err, linmix_kwargs=dict(K=1))
    results.to_csv("results/run_lee20_3.csv", index=False)
